    ...
    <div id="notifications-view" className="space-y-6 animate-in fade-in duration-200">
      ...
      <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-xs flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">
              התראות אוטומטיות על דדליינים, עומסי יתר, שעות סרק ומשימות מעוכבות
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 bg-slate-100 hover:bg-rose-50 hover:text-rose-600 text-slate-700 text-xs font-semibold px-3 py-2 rounded-xl transition-colors"
          >
      ...
      <div className="bg-white p-3.5 rounded-xl border border-slate-200 shadow-xs flex items-center justify-between text-xs">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-slate-700">סינון:</span>
          <select
          ...
          >
            ...
            <option value="warning">אזהרות בלבד</option>
            <option value="info">מידע בלבד</option>
          </select>
        </div>
      ...
      <div className="space-y-2.5">
          ...
          <div
            ...
            className={`p-4 rounded-2xl border transition-all flex items-start justify-between gap-4 cursor-pointer ${
              notif.isRead
                ...
                : 'bg-blue-50/40 border-blue-200 hover:border-blue-400 shadow-xs'
            }`}
          >
            ...
            {notif.linkTo && (
              <div className="flex items-center gap-1 text-xs text-blue-600 hover:text-blue-800 font-semibold shrink-0 pt-1">
                <span>צפה עכשיו</span>
        ...
        {filteredNotifications.length === 0 && (
          <div className="bg-white p-12 text-center rounded-2xl border border-slate-200 space-y-2">
            ...
            <h4 className="font-bold text-slate-800 text-sm">אין התראות כרגע</h4>
            <p className="text-xs text-slate-500">כל המשימות והקיבולות נמצאות בטווח התקין.</p>
          </div>
        )}
      </div>
    </div>
