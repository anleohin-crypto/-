...
## WIP15
- Fixed Excel task date validation: malformed provided dates are no longer silently replaced by today's date.
- Added explicit validation errors for invalid start/end/deadline calendar dates.
